        ...
        <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
          {counsellors.map((counsellor) => (
            <a key={counsellor.id} href={counsellor.href} className="group">
              <div className="aspect-h-1 aspect-w-1 h-50 w-50 overflow-hidden rounded-lg bg-gray-200 ">
                <img
                  src={counsellor.imageSrc}
                  alt={counsellor.imageAlt}
                  className="aspect-h-1 aspect-w-1 h-50 w-50 object-cover object-center group-hover:opacity-75"
                />
              </div>
